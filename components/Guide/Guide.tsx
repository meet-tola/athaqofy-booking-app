    ...
    <div className="flex flex-col items-center justify-center w-full p-8 lg:p-20 space-y-8">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div className="relative p-6 border rounded-lg shadow-sm">
          ...
          <h2 className="mt-8 text-lg font-bold text-center">Intention For Hajj</h2>
          <p className="mt-2 text-center text-gray-600">
            Muslims commence their Hajj journey by declaring intention for the sacred pilgrimage to Mecca, a profound
            act.
          </p>
        </div>
        <div className="relative p-6 border rounded-lg shadow-sm">
