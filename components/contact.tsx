    ...
    <section id="contact" className="py-24 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <Card className="border border-gray-200">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-gray-900">Get Support</CardTitle>
            </CardHeader>
            <CardContent className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">08033040661</p>
                  <p className="text-gray-600">070651745060</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">athaqofy@gmail.com</p>
                  <p className="text-gray-600">support@athaqofy.com</p>
